 ...
 */
@WebServlet(name = "ControladorSugerencia", urlPatterns = {"/Sugerencia"})
public class ControladorSugerencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String correopara=request.getParameter("correopara");
            String clave=request.getParameter("clave");
            String sugerencia=request.getParameter("sugerencia");
            
            
            SugerenciaDAO sugerenciadao=new SugerenciaDAO();
            if(sugerenciadao.enviarcorreo(correouser,correopara,clave,sugerencia)){
