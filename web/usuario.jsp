                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Padre de familia recuerde registrar o actualizar los datos de Peso y Estatura despues de haberse registrado.Debe ir a la opción <b>Datos de Crecimiento</b> de menú principal. 
                            <br>Si ya lo realizo hacer caso omiso de este informe.</p>
                            <p>Desea actualizar la información de su hij@, si es así debe dar click en el botón 
