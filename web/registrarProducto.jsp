                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="nombreProducto" placeholder="Nombre producto" id="producto">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="categoria" class="form-control" required id="categoria">
                                                                ...
                                                                <option value="1">Hortalizas/vegetales</option>
                                                                <option value="2">Legumbres</option>
                                                                ...
                                                                <option value="8">Embutido</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="calorias" placeholder="Calorias" id="calorias">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="hidratos" placeholder="Hidratos" id="hidratos">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="grasas" placeholder="Grasas" id="grasas">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="proteinas" onclick="validate()" placeholder="Proteinas" id="proteinas">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                <button type="reset" class="btn btn-gradient-light btn-rounded btn-fw">Restablecer</button>
                                                <button type="submit" name="Ingresar" class="btn btn-gradient-success btn-rounded btn-fw" onclick="validate()" id="btnenviar">Ingresar Producto</button>
                                                <input type="hidden" name="opcion" value="3">
                                        </form>
                                    </div>
                                </div>
