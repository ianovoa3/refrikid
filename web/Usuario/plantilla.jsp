            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                  <h6 class="preview-subject ellipsis mb-1 font-weight-normal">Mark te envió un mensaje</h6>
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                  <h6 class="preview-subject ellipsis mb-1 font-weight-normal">Cregh te envió un mensaje</h6>
                  <p class="text-gray mb-0">
                    Hace 15 minutos
                  </p>
                </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../ninoslongitud0a5.jsp">Altura Niños 0 A 5 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="../ninaslongitudmax5.jsp">Altura Niños mayores A 5 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="../ninospeso0a5.jsp">Peso Niños 0 A 5 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="../ninospesomax5.jsp">Peso Niños Mayores A 5 </a></li>
                <div class="dropdown-divider"></div>
                <li class="nav-item"> <a class="nav-link" href="../ninaslongitud0a5.jsp">Altura Niñas 0 A 5 </a></li>
                <li class="nav-item"> <a class="nav-link" href="../ninaslongitudmax5.jsp">Altura Niñas Mayores A 5 </a></li>
                <li class="nav-item"> <a class="nav-link" href="../ninaspeso0a5.jsp">Peso Niñas 0 A 5 </a></li>
                <li class="nav-item"> <a class="nav-link" href="">Peso Niñas Mayores A 5 </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
