function CalendarApp(date) {
  ...
  this.months = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Deciembre'];
  this.quotes = [];
  this.apts = [
    {
...
CalendarApp.prototype.showEventsCreateElesView = function(events) {
  ...
  events.forEach(function(event){
    ...
    // li.innerHtml
    var html = "<span class='start-time'>" + _start.toLocaleTimeString(navigator.language,{hour: '2-digit', minute:'2-digit'}) + "</span> <small>hasta</small> ";
