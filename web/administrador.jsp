                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="img/logotipoFinal.png" class="img-fluid" alt="Responsive image"><br><br>
                                        <p><b>Si desea ingresar un nuevo producto debe dar click en el botón</b>
                                            <a href="registrarProducto.jsp">
                                                <button class="btn btn-gradient-success btn-sm" id="btnenviar">
                                                    Nuevo Producto
                                                </button>
                                            </a>
                                        </p>
